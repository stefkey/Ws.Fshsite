<?php
namespace Ws\FshImport\Command;
...
class ImportCommandController extends CommandController {
	...
	protected function getAccounts() {
		$sql = "SELECT f.username, n.confirmeddate, n.name FROM con_frontendusers AS f JOIN con_news_rcp AS n ON f.username = n.email WHERE f.active = 1";
